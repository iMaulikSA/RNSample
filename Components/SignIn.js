...
import {
    Alert, Image, TextInput, Text, View, ImageBackground, TouchableOpacity, ActivityIndicator
} from 'react-native'
...
import { onSetToken, onSetUser } from "../Redux/UserAction";
...
class SignIn extends Component {
    ...
    storeUserData = async (userData) => {
        try {
            ...
            //this.props.onSetToken(responseJSON.token);
